...
{
    public static function getPhrase(int $statusCode): string
    {
        $title = match($statusCode) {
            ...
            self::STATUS_PAYLOAD_TOO_LARGE => "Content Too Large",
            ...
            self::STATUS_UNPROCESSABLE_ENTITY => "Unprocessable Content",
